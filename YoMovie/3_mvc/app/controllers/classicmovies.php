<?php
class classicmovies extends Controller {
    public function index() {
        $dataInput = $this->getBasicList();
        $this->view('classicmovies/classicmovies', $dataInput);
    }
    ...
    public function test(){
        ...
        if($_GET['decisions']!=""){
            ...
            $sqlCustomQuery = $sqlCustomQuery . " (SELECT COUNT(*) FROM choices WHERE text_intrebare IS NULL AND movie_id = movies.id GROUP BY movie_id)" . $prag;
        }
