...
<body>
    <div id="wrapper">
        <nav>
                <button onclick="location.href='/mvc/public/home';" id="currentButton">Home</button>
        ...
        <?php
            ...
            foreach($data as $movie)
                if($movie->title!="")echo '<a style="text-decoration:none" onclick="giveView(' . $movie->id . ')" href="/mvc/public/watchController/watch/' . $movie->clip_id . '">
                    <article>
